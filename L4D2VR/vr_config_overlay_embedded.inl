...
namespace
{
    ...
    static const CfgOptionSpec kCfgOptionSpecs[] =
    {
        ...
        { "VrHandsTwoHandedGripTargetBoxScale", CfgOptionType::Float, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Box Scale", 0.25f, 8.0f, "1.0" },
    ...
    static const CfgOptionTextSpec kCfgOptionTextSpecs[] =
    {
        ...
        { "VrHandsTwoHandedGripAlways", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Gun Pose", "Two-hand Gun Pose", "Keeps both VR hands on the weapon using the original viewmodel hand animation. This is a force switch; it does not check proximity yet.", "", "Applies to both built-in native hands and separate glove models.", "" },
    ...
    static const CfgEnglishTextOverride kCfgEnglishTextOverrides[] =
    {
        ...
        { "VrHandsTwoHandedGripAlways", "Hands / Reload", "Force Two-hand Gun Pose", "Keeps both hands on the weapon using the original viewmodel hand animation.", "This is the first switch-only version; proximity-to-bone activation can be added on top later." },
