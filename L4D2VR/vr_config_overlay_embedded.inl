...
namespace
{
    ...
    static const CfgOptionSpec kCfgOptionSpecs[] =
    {
        ...
        { "NativeViewmodelHandsOnlyAutoHelperLeftCutRotationDeg", CfgOptionType::Vec3, "\xE6\x89\x8B\xE9\x83\xA8 / \xE8\xB0\x83\xE8\xAF\x95", "Auto Helper Left Cut", -89.0f, 89.0f, "30,-35,70" },
        { "NativeViewmodelHandsOnlyAutoHelperRightCutRotationDeg", CfgOptionType::Vec3, "\xE6\x89\x8B\xE9\x83\xA8 / \xE8\xB0\x83\xE8\xAF\x95", "Auto Helper Right Cut", -89.0f, 89.0f, "50,45,55" },
    ...
    static const CfgOptionTextSpec kCfgOptionTextSpecs[] =
    {
        ...
        { "NativeViewmodelHandsOnlyAutoCutRotation", "Hands / Debug", "\346\211\213\351\203\250 / \350\260\203\350\257\225", "Auto Cut Rotation", "Auto Cut Rotation", "Automatically switches the native hand cut rotation for helper-heavy custom arm rigs.", "Automatically switches the native hand cut rotation for helper-heavy custom arm rigs.", "Leave this on unless you are debugging a specific model.", "" },
        { "NativeViewmodelHandsOnlyAutoHelperLeftCutRotationDeg", "Hands / Debug", "\346\211\213\351\203\250 / \350\260\203\350\257\225", "Auto Helper Left Cut", "Auto Helper Left Cut", "Left-hand cut rotation used when a helper-heavy custom arm rig is detected.", "Left-hand cut rotation used when a helper-heavy custom arm rig is detected.", "This is a fallback for rigs whose forearm-to-hand axis differs from the official-style arms.", "" },
        { "NativeViewmodelHandsOnlyAutoHelperRightCutRotationDeg", "Hands / Debug", "\346\211\213\351\203\250 / \350\260\203\350\257\225", "Auto Helper Right Cut", "Auto Helper Right Cut", "Right-hand cut rotation used when a helper-heavy custom arm rig is detected.", "Right-hand cut rotation used when a helper-heavy custom arm rig is detected.", "This is a fallback for rigs whose forearm-to-hand axis differs from the official-style arms.", "" },
    ...
    static bool CfgIsSpecVisible(const CfgOverlayState& s, const CfgOptionSpec& spec)
    {
        ...
        if (std::strcmp(key, "NativeViewmodelHandsOnlyWristKeepFraction") == 0 ||
            ...
            std::strcmp(key, "NativeViewmodelHandsOnlyAutoHelperLeftCutRotationDeg") == 0 ||
            std::strcmp(key, "NativeViewmodelHandsOnlyAutoHelperRightCutRotationDeg") == 0 ||
