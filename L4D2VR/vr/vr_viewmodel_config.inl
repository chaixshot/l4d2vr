...
void VR::ParseConfigFile()
{
    ...
    m_ThirdPersonFrontViewOverlayWidthMeters = std::clamp(
    ...
    m_MagazineInteractionSeparateButtonInput = getBool("MagazineInteractionSeparateButtonInput", m_MagazineInteractionSeparateButtonInput);
