...
namespace
{
    ...
    static const CfgOptionSpec kCfgOptionSpecs[] =
    {
        ...
        { "VrHandsTwoHandedGripAlways", CfgOptionType::Bool, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Gun Pose", 0.0f, 0.0f, "false" },
        { "VrHandsTwoHandedGripTargetBoxScale", CfgOptionType::Float, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Box Scale", 0.25f, 8.0f, "2.0" },
        { "VrHandsTwoHandedAimEnabled", CfgOptionType::Bool, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Aim", 0.0f, 0.0f, "true" },
        { "VrHandsTwoHandedAimMountFriendly", CfgOptionType::Bool, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Physical Stock Mode", 0.0f, 0.0f, "false" },
        { "VrHandsVirtualStockEnabled", CfgOptionType::Bool, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Virtual Stock", 0.0f, 0.0f, "false" },
        { "VrHandsTwoHandedAimStrength", CfgOptionType::Float, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Aim Strength", 0.0f, 1.0f, "1.0" },
        { "VrHandsTwoHandedAimSmoothingSeconds", CfgOptionType::Float, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Smoothing", 0.0f, 0.25f, "0.025" },
        { "VrHandsTwoHandedAimOffhandOffsetMeters", CfgOptionType::Vec3, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Off-hand Aim Offset", -0.5f, 0.5f, "0.12,0.0,0.0" },
        { "VrHandsVirtualStockStrength", CfgOptionType::Float, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Virtual Stock Strength", 0.0f, 1.0f, "0.65" },
        { "VrHandsVirtualStockOffsetMeters", CfgOptionType::Vec3, "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Virtual Stock Offset", -0.75f, 0.75f, "-0.28,0.16,-0.12" },
    ...
    static const CfgOptionTextSpec kCfgOptionTextSpecs[] =
    {
        ...
        { "LeftHandedSwapInputActions", "Input / Turning", "\350\276\223\345\205\245 / \350\275\254\345\220\221", "Swap Left-Handed Inputs", "\xE5\xB7\xA6\xE6\x89\x8B\xE6\xA8\xA1\xE5\xBC\x8F\xE8\xBE\x93\xE5\x85\xA5\xE4\xBA\x92\xE6\x8D\xA2", "When Left-Handed Mode is enabled, mirrors paired controls: Primary/Secondary, Reload/Crouch, Walk/Turn, Reset/Flashlight.", "\xE5\x90\xAF\xE7\x94\xA8\xE5\xB7\xA6\xE6\x89\x8B\xE6\xA8\xA1\xE5\xBC\x8F\xE6\x97\xB6\xEF\xBC\x8C\xE4\xBA\x92\xE6\x8D\xA2\xE6\x88\x90\xE5\xAF\xB9\xE6\x8E\xA7\xE5\x88\xB6\xEF\xBC\x9A\xE4\xB8\xBB\xE6\x94\xBB\xE5\x87\xBB/\xE5\x89\xAF\xE6\x94\xBB\xE5\x87\xBB\xE3\x80\x81\xE6\x8D\xA2\xE5\xBC\xB9/\xE8\xB9\xB2\xE4\xB8\x8B\xE3\x80\x81\xE8\xA1\x8C\xE8\xB5\xB0/\xE8\xBD\xAC\xE5\x90\x91\xE3\x80\x81\xE9\x87\x8D\xE7\xBD\xAE/\xE6\x89\x8B\xE7\x94\xB5\xE7\xAD\x92\xE3\x80\x82", "A/B/X/Y-only actions are not guessed or remapped.", "\xE4\xB8\x8D\xE4\xBC\x9A\xE7\x8C\x9C\xE6\xB5\x8B\xE6\x88\x96\xE9\x87\x8D\xE6\x98\xA0\xE5\xB0\x84\xE4\xBB\x85 A/B/X/Y \xE7\x9A\x84\xE5\x8A\xA8\xE4\xBD\x9C\xE3\x80\x82" },
        ...
        { "VrHandsTwoHandedGripAlways", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Gun Pose", "Two-hand Gun Pose", "Keeps both VR hands on the weapon using the original viewmodel hand animation.", "", "Applies to both built-in native hands and separate glove models.", "" },
        { "VrHandsTwoHandedGripTargetBoxScale", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Box Scale", "Two-hand Box Scale", "Scales the green left-hand target box used to enter the two-hand gun pose.", "", "Affects both the debug box and grip activation range. Magazine boxes are unchanged.", "" },
        { "VrHandsTwoHandedAimEnabled", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Aim", "Two-hand Aim", "Lets the off hand participate in the weapon aiming pose while the two-hand gun pose is active.", "", "Right hand stays the rear grip; left hand acts as the forward grip.", "" },
        { "VrHandsTwoHandedAimMountFriendly", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Physical Stock Mode", "Physical Stock Mode", "Disables the Pavlov-style virtual off-hand grip offset for physical gun-stock users.", "", "Leave off for controller-only play.", "" },
        { "VrHandsVirtualStockEnabled", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Virtual Stock", "Virtual Stock", "Adds a shoulder-like virtual anchor to stabilize two-handed long-gun aiming.", "", "Only affects aiming while Two-hand Aim is active.", "" },
        { "VrHandsTwoHandedAimStrength", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Aim Strength", "Two-hand Aim Strength", "Blends from right-controller-only aiming to off-hand-assisted aiming.", "", "1.0 follows the left/right hand line fully.", "" },
        { "VrHandsTwoHandedAimSmoothingSeconds", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Two-hand Smoothing", "Two-hand Smoothing", "Applies light low-pass smoothing to the resolved two-hand weapon aim.", "", "Raise slightly if the muzzle jitters.", "" },
        { "VrHandsTwoHandedAimOffhandOffsetMeters", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Off-hand Aim Offset", "Off-hand Aim Offset", "Offsets the left-hand virtual forward grip in weapon-local meters: X forward, Y right, Z up.", "", "Physical Stock Mode ignores this offset.", "" },
        { "VrHandsVirtualStockStrength", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Virtual Stock Strength", "Virtual Stock Strength", "Controls how strongly the shoulder anchor stabilizes the weapon direction.", "", "0 disables the anchor blend; 1 follows it fully.", "" },
        { "VrHandsVirtualStockOffsetMeters", "Hands / Reload", "\xE6\x89\x8B\xE9\x83\xA8 / \xE6\x8D\xA2\xE5\xBC\xB9", "Virtual Stock Offset", "Virtual Stock Offset", "Shoulder anchor offset in body-local meters: X forward, Y dominant side, Z up.", "", "Default is behind, dominant-side, and slightly below the HMD.", "" },
    ...
    static const CfgEnglishTextOverride kCfgEnglishTextOverrides[] =
    {
        ...
        { "VrHandsTwoHandedGripAlways", "Hands / Reload", "Force Two-hand Gun Pose", "Keeps both hands on the weapon using the original viewmodel hand animation.", "The normal runtime toggle still uses the green left-hand target box." },
        { "VrHandsTwoHandedGripTargetBoxScale", "Hands / Reload", "Two-hand Grip Box Scale", "Multiplies the green two-hand grip target box size.", "Increase when the middle-finger target is too hard to hit." },
        { "VrHandsTwoHandedAimEnabled", "Hands / Reload", "Two-hand Aim", "Uses the off hand as a forward grip while two-hand gun pose is active.", "This is the Pavlov-style two-point weapon pose path." },
        { "VrHandsTwoHandedAimMountFriendly", "Hands / Reload", "Physical Stock Mode", "Disables the virtual off-hand grip offset.", "Use this with a real gun stock or fixed controller mount." },
        { "VrHandsVirtualStockEnabled", "Hands / Reload", "Virtual Stock", "Adds a shoulder-like virtual anchor to stabilize long-gun aiming.", "Enable when you want less wrist wobble while holding rifles or shotguns." },
        { "VrHandsTwoHandedAimStrength", "Hands / Reload", "Two-hand Aim Strength", "Controls how much the left hand pulls the weapon direction.", "Lower values keep more of the right-controller aim." },
        { "VrHandsTwoHandedAimSmoothingSeconds", "Hands / Reload", "Two-hand Aim Smoothing", "Applies a small time-based smoothing filter to two-hand aim.", "0 disables smoothing." },
        { "VrHandsTwoHandedAimOffhandOffsetMeters", "Hands / Reload", "Off-hand Aim Offset", "Moves the virtual forward grip relative to the weapon basis.", "X is forward, Y is right, Z is up, in meters." },
        { "VrHandsVirtualStockStrength", "Hands / Reload", "Virtual Stock Strength", "Controls how much the virtual shoulder anchor affects direction.", "Too high can feel sticky; too low behaves like plain two-hand aiming." },
        { "VrHandsVirtualStockOffsetMeters", "Hands / Reload", "Virtual Stock Offset", "Moves the virtual shoulder anchor in body space.", "X is forward/back, Y is dominant side, Z is up/down, in meters." },
    ...
    static bool CfgIsSpecVisible(const CfgOverlayState& s, const CfgOptionSpec& spec)
    {
        ...
        if (std::strcmp(key, "MotionGestureSwingThreshold") == 0)
            return CfgIsEnabled(s, "MotionGesturesEnabled", true) &&
                CfgIsEnabled(s, "MotionGestureSwingEnabled", true);
        if (std::strcmp(key, "MotionGesturePushThreshold") == 0)
            return CfgIsEnabled(s, "MotionGesturesEnabled", true) &&
                CfgIsEnabled(s, "MotionGesturePushEnabled", true);
        if (std::strcmp(key, "MotionGestureDownSwingThreshold") == 0)
            return CfgIsEnabled(s, "MotionGesturesEnabled", true) &&
                CfgIsEnabled(s, "MotionGestureDownSwingEnabled", true);
        if (std::strcmp(key, "MotionGestureJumpThreshold") == 0)
            return CfgIsEnabled(s, "MotionGesturesEnabled", true) &&
                CfgIsEnabled(s, "MotionGestureJumpEnabled", true);

        if (CfgStartsWith(key, "MotionGesture") &&
            std::strcmp(key, "MotionGesturesEnabled") != 0)
            return CfgIsEnabled(s, "MotionGesturesEnabled", true);
        ...
        if (CfgStartsWith(key, "VrHandsTwoHanded") ||
            CfgStartsWith(key, "VrHandsVirtualStock"))
        {
            return vrHandsEntryEnabled;
        }
