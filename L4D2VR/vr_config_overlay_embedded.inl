...
namespace
{
    ...
    static const CfgOptionSpec kCfgOptionSpecs[] =
    {
        ...
        { "NativeViewmodelHandsOnlyTrimUnits", CfgOptionType::Float, "\xE6\x89\x8B\xE9\x83\xA8 / \xE8\xB0\x83\xE8\xAF\x95", "Native Trim Units", 0.0f, 32.0f, "0.0" },
    ...
    static const CfgOptionTextSpec kCfgOptionTextSpecs[] =
    {
        ...
        { "NativeViewmodelHandsOnlyTrimUnits", "Hands / Debug", "\346\211\213\351\203\250 / \350\260\203\350\257\225", "Native Trim Units", "Native Trim Units", "Moves both native hand clipping planes toward the fingers in Source units. Leave this at 0 for a wrist crop.", "Moves both native hand clipping planes toward the fingers in Source units. Leave this at 0 for a wrist crop.", "Use only if the wrist itself is too long; higher values can cut into the hand.", "" },
