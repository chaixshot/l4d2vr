...
namespace
{
    ...
    static const CfgOptionSpec kCfgOptionSpecs[] =
    {
        ...
        { "VrHandsTwoHandedGripAlways", CfgOptionType::Bool, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Two-hand Gun Pose", 0.0f, 0.0f, "false" },
        { "VrHandsTwoHandedGripTargetBoxScale", CfgOptionType::Float, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Two-hand Box Scale", 0.25f, 8.0f, "2.0" },
        { "VrHandsTwoHandedAimEnabled", CfgOptionType::Bool, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Two-hand Aim", 0.0f, 0.0f, "true" },
        { "VrHandsTwoHandedAimMountFriendly", CfgOptionType::Bool, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Physical Stock Mode", 0.0f, 0.0f, "false" },
        { "VrHandsVirtualStockEnabled", CfgOptionType::Bool, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Virtual Stock", 0.0f, 0.0f, "false" },
        { "VrHandsTwoHandedAimStrength", CfgOptionType::Float, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Two-hand Aim Strength", 0.0f, 1.0f, "1.0" },
        { "VrHandsTwoHandedAimSmoothingSeconds", CfgOptionType::Float, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Two-hand Smoothing", 0.0f, 0.25f, "0.025" },
        { "VrHandsTwoHandedAimOffhandOffsetMeters", CfgOptionType::Vec3, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Off-hand Aim Offset", -0.5f, 0.5f, "0.12,0.0,0.0" },
        { "VrHandsVirtualStockStrength", CfgOptionType::Float, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Virtual Stock Strength", 0.0f, 1.0f, "0.65" },
        { "VrHandsVirtualStockOffsetMeters", CfgOptionType::Vec3, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Virtual Stock Offset", -0.75f, 0.75f, "-0.28,0.16,-0.12" },
    ...
    static const CfgOptionTextSpec kCfgOptionTextSpecs[] =
    {
        ...
        { "VrHandsTwoHandedGripAlways", "Hands / VR Hands", "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Two-hand Gun Pose", "Two-hand Gun Pose", "Keeps both VR hands on the weapon using the original viewmodel hand animation.", "", "Applies to both built-in native hands and separate glove models.", "" },
        { "VrHandsTwoHandedGripTargetBoxScale", "Hands / VR Hands", "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Two-hand Box Scale", "Two-hand Box Scale", "Scales the touch padding around the weapon box used to enter the two-hand gun pose.", "", "The magazine box remains an exclusion zone so reload input can win there.", "" },
        { "VrHandsTwoHandedAimEnabled", "Hands / VR Hands", "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Two-hand Aim", "Two-hand Aim", "Lets the off hand participate in the weapon aiming pose while the two-hand gun pose is active.", "", "Right hand stays the rear grip; left hand acts as the forward grip.", "" },
        { "VrHandsTwoHandedAimMountFriendly", "Hands / VR Hands", "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Physical Stock Mode", "Physical Stock Mode", "Disables the Pavlov-style virtual off-hand grip offset for physical gun-stock users.", "", "Leave off for controller-only play.", "" },
        { "VrHandsVirtualStockEnabled", "Hands / VR Hands", "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Virtual Stock", "Virtual Stock", "Adds a shoulder-like virtual anchor to stabilize two-handed long-gun aiming.", "", "Only affects aiming while Two-hand Aim is active.", "" },
        { "VrHandsTwoHandedAimStrength", "Hands / VR Hands", "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Two-hand Aim Strength", "Two-hand Aim Strength", "Blends from right-controller-only aiming to off-hand-assisted aiming.", "", "1.0 follows the left/right hand line fully.", "" },
        { "VrHandsTwoHandedAimSmoothingSeconds", "Hands / VR Hands", "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Two-hand Smoothing", "Two-hand Smoothing", "Applies light low-pass smoothing to the resolved two-hand weapon aim.", "", "Raise slightly if the muzzle jitters.", "" },
        { "VrHandsTwoHandedAimOffhandOffsetMeters", "Hands / VR Hands", "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Off-hand Aim Offset", "Off-hand Aim Offset", "Offsets the left-hand virtual forward grip in weapon-local meters: X forward, Y right, Z up.", "", "Physical Stock Mode ignores this offset.", "" },
        { "VrHandsVirtualStockStrength", "Hands / VR Hands", "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Virtual Stock Strength", "Virtual Stock Strength", "Controls how strongly the shoulder anchor stabilizes the weapon direction.", "", "0 disables the anchor blend; 1 follows it fully.", "" },
        { "VrHandsVirtualStockOffsetMeters", "Hands / VR Hands", "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "Virtual Stock Offset", "Virtual Stock Offset", "Shoulder anchor offset in body-local meters: X forward, Y dominant side, Z up.", "", "Default is behind, dominant-side, and slightly below the HMD.", "" },
    ...
    static const CfgEnglishTextOverride kCfgEnglishTextOverrides[] =
    {
        ...
        { "VrHandsTwoHandedGripAlways", "Hands / VR Hands", "Force Two-hand Gun Pose", "Keeps both hands on the weapon using the original viewmodel hand animation.", "The normal runtime toggle activates when the off hand touches the weapon, except inside the magazine box." },
        { "VrHandsTwoHandedGripTargetBoxScale", "Hands / VR Hands", "Two-hand Grip Box Scale", "Scales the touch padding around the weapon box.", "The magazine box remains excluded to avoid conflicting with manual reload." },
        { "VrHandsTwoHandedAimEnabled", "Hands / VR Hands", "Two-hand Aim", "Uses the off hand as a forward grip while two-hand gun pose is active.", "This is the Pavlov-style two-point weapon pose path." },
        { "VrHandsTwoHandedAimMountFriendly", "Hands / VR Hands", "Physical Stock Mode", "Disables the virtual off-hand grip offset.", "Use this with a real gun stock or fixed controller mount." },
        ...
        { "VrHandsTwoHandedAimStrength", "Hands / VR Hands", "Two-hand Aim Strength", "Controls how much the left hand pulls the weapon direction.", "Lower values keep more of the right-controller aim." },
