...
namespace
{
    ...
    static const CfgOptionSpec kCfgOptionSpecs[] =
    {
        ...
        { "VrHandsTwoHandedAimOffhandOffsetMeters", CfgOptionType::Vec3, "\xE6\x89\x8B\xE9\x83\xA8 / VR \xE5\x8F\x8C\xE6\x89\x8B", "\xE5\x89\xAF\xE6\x89\x8B\xE6\x8F\xA1\xE7\x82\xB9\xE5\x81\x8F\xE7\xA7\xBB", -0.5f, 0.5f, "0.12,0.0,0.0" },
    ...
    static const CfgEnglishTextOverride kCfgEnglishTextOverrides[] =
    {
        ...
        { "VrHandsTwoHandedAimMountFriendly", "Hands / VR Hands", "Physical Stock Mode", "Uses a viewmodel-layer right-controller forward stock box for automatic two-hand grip.", "Hold the off hand inside for 0.5 seconds; leaving exits, and magazine touch still wins before the clip is full." },
