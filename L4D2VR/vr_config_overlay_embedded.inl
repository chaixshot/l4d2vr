...
namespace
{
    ...
    static const CfgOptionSpec kCfgOptionSpecs[] =
    {
        ...
        { "LeftHandedSwapInputActions", CfgOptionType::Bool, "\xE8\xBE\x93\xE5\x85\xA5 / \xE8\xBD\xAC\xE5\x90\x91", "Swap Left-Handed Inputs", 0.0f, 0.0f, "false" },
        ...
        { "ViewmodelBoneLabelsEnabled", CfgOptionType::Bool, "Hands / Reload", "Viewmodel Bone Labels", 0.0f, 0.0f, "false" },
        ...
        { "ManualReloadMagazineInsertionAxisLocal", CfgOptionType::Vec3, "Magazine Interaction", "\345\274\271\345\214\243\346\217\222\345\205\245\350\275\264", -1.0f, 1.0f, "0,-1,0" },
        { "ManualReloadMagazineHandOffsetMeters", CfgOptionType::Vec3, "Magazine Interaction", "\346\211\213\346\214\201\345\274\271\345\214\243\344\275\215\347\275\256\345\201\217\347\247\273", -1.0f, 1.0f, "0,0,0" },
        { "ManualReloadMagazineHandRotationOffsetDeg", CfgOptionType::Vec3, "Magazine Interaction", "\346\211\213\346\214\201\345\274\271\345\214\243\350\247\222\345\272\246\345\201\217\347\247\273", -180.0f, 180.0f, "0,0,0" },
    ...
    static const CfgOptionTextSpec kCfgOptionTextSpecs[] =
    {
        ...
        { "LeftHandedSwapInputActions", "Input / Turning", "\350\276\223\345\205\245 / \350\275\254\345\220\221", "Swap Left-Handed Inputs", "Swap Left-Handed Inputs", "When Left-Handed Mode is enabled, mirrors paired controls: Primary/Secondary, Reload/Crouch, Walk/Turn, Reset/Flashlight.", "When Left-Handed Mode is enabled, mirrors paired controls: Primary/Secondary, Reload/Crouch, Walk/Turn, Reset/Flashlight.", "A/B/X/Y-only actions are not guessed or remapped.", "A/B/X/Y-only actions are not guessed or remapped." },
        ...
        { "MotionGesturesEnabled", "Motion Gestures", "\345\212\250\344\275\234\346\211\213\345\212\277", "Enable Motion Gestures", "\xE5\x90\xAF\xE7\x94\xA8\xE4\xBD\x93\xE6\x84\x9F\xE6\x89\x8B\xE5\x8A\xBF", "Allows controller and HMD movement gestures to synthesize reload, shove, and jump inputs.", "Allows controller and HMD movement gestures to synthesize reload, shove, and jump inputs.", "Turn this off if fast hand movement causes accidental reloads or shoves.", "Turn this off if fast hand movement causes accidental reloads or shoves." },
